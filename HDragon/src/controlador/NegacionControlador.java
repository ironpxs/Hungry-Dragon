 ...
 */
public class NegacionControlador implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //Negacion
        btnOpCorrect = btnNegacion;
        imgComida1.setVisible(false);
        ThreadNegacion nivelNegacion = new ThreadNegacion(imgDragon,seg,intento,lblTiempo,lblPuntos,lblIntento,btnOpCorrect,opciones, lblEnunciado);
        Runnable r3 = nivelNegacion;
        Thread hiloNegacion = new Thread(r3);
        colocarImagenes(nivelNegacion.getRutas());
        hiloNegacion.start();   
    }
