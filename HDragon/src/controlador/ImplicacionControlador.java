...
import modelo.ThreadImplicacion;
import modelo.ThreadNegacion;
 ...
 */
public class ImplicacionControlador implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //Implicacion
        btnOpCorrect = btnImplicacion;
        imgComida1.setVisible(true);
        ThreadImplicacion nivelImplicacion = new ThreadImplicacion(imgDragon,seg,intento,lblTiempo,lblPuntos,lblIntento,btnOpCorrect,opciones, lblEnunciado);
        Runnable r3 = nivelImplicacion;
        Thread hiloImplicacion = new Thread(r3);
        colocarImagenes(nivelImplicacion.getRutas());
   ...
   private void colocarImagenes(RutasImagenesNiveles rutas){
       ...
       btnImplicacion.setGraphic((new ImageView(imagenOp1)));
